...
{
    private static readonly System.Type CachedType = typeof(VisualShaderNodeOuterProduct);

    private static readonly StringName NativeName = "VisualShaderNodeOuterProduct";
