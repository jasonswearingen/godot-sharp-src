...
/// </summary>
public partial class VisualShaderNodeIntConstant : VisualShaderNodeConstant
{
    /// <summary>
    ...
    private static readonly System.Type CachedType = typeof(VisualShaderNodeIntConstant);

    private static readonly StringName NativeName = "VisualShaderNodeIntConstant";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public VisualShaderNodeIntConstant() : this(true)
    {
        unsafe
        {
    ...
    internal VisualShaderNodeIntConstant(bool memoryOwn) : base(memoryOwn) { }
