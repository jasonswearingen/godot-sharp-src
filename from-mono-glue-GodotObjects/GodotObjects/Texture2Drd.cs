...
#nullable disable
/// <summary>
/// <para>This texture class allows you to use a 2D texture created directly on the <see cref="Godot.RenderingDevice"/> as a texture for materials, meshes, etc.</para>
/// </summary>
[GodotClassName("Texture2DRD")]
public partial class Texture2Drd : Texture2D
{
    /// <summary>
    ...
    private static readonly System.Type CachedType = typeof(Texture2Drd);

    private static readonly StringName NativeName = "Texture2DRD";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public Texture2Drd() : this(true)
    {
        unsafe
        {
    ...
    internal Texture2Drd(bool memoryOwn) : base(memoryOwn) { }
