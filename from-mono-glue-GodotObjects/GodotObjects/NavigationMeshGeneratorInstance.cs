...
public partial class NavigationMeshGeneratorInstance : GodotObject
{
    private static readonly System.Type CachedType = typeof(NavigationMeshGeneratorInstance);

    private static readonly StringName NativeName = "NavigationMeshGenerator";

    internal NavigationMeshGeneratorInstance() : this(false)
    {
        unsafe
        {
    ...
    internal NavigationMeshGeneratorInstance(bool memoryOwn) : base(memoryOwn) { }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind0 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Bake, 1401173477ul);
    ...
    {
        NativeCalls.godot_icall_2_240(MethodBind0, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(rootNode));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind1 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Clear, 2923361153ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = ClassDB_get_method_with_compatibility(NativeName, MethodName.ParseSourceGeometryData, 685862123ul);

    /// <summary>
    /// <para>Parses the <see cref="Godot.SceneTree"/> for source geometry according to the properties of <paramref name="navigationMesh"/>. Updates the provided <paramref name="sourceGeometryData"/> resource with the resulting data. The resource can then be used to bake a navigation mesh with <see cref="Godot.NavigationMeshGeneratorInstance.BakeFromSourceGeometryData(NavigationMesh, NavigationMeshSourceGeometryData3D, Callable)"/>. After the process is finished the optional <paramref name="callback"/> will be called.</para>
    ...
    {
        NativeCalls.godot_icall_4_722(MethodBind2, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), GodotObject.GetPtr(rootNode), callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = ClassDB_get_method_with_compatibility(NativeName, MethodName.BakeFromSourceGeometryData, 2469318639ul);
    ...
    {
        NativeCalls.godot_icall_3_723(MethodBind3, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), callback);
    }
