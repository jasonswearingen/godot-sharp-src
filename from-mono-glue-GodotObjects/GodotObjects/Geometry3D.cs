...
public static partial class Geometry3D
{
    ...
    private static Geometry3DInstance singleton;

    public static Geometry3DInstance Singleton =>
        singleton ??= (Geometry3DInstance)InteropUtils.EngineGetSingleton("Geometry3D");

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind0 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ComputeConvexMeshPoints, 1936902142ul);

    /// <summary>
    /// <para>Calculates and returns all the vertex points of a convex shape defined by an array of <paramref name="planes"/>.</para>
    /// </summary>
    public static Vector3[] ComputeConvexMeshPoints(Godot.Collections.Array<Plane> planes)
    {
        return NativeCalls.godot_icall_1_559(MethodBind0, GodotObject.GetPtr(Singleton), (godot_array)(planes ?? new()).NativeValue);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind1 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.BuildBoxPlanes, 3622277145ul);
    ...
    /// </summary>
    public static unsafe Godot.Collections.Array<Plane> BuildBoxPlanes(Vector3 extents)
    {
        return new Godot.Collections.Array<Plane>(NativeCalls.godot_icall_1_560(MethodBind1, GodotObject.GetPtr(Singleton), &extents));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.BuildCylinderPlanes, 449920067ul);
    ...
    /// </summary>
    public static Godot.Collections.Array<Plane> BuildCylinderPlanes(float radius, float height, int sides, Vector3.Axis axis = (Vector3.Axis)(2))
    {
        return new Godot.Collections.Array<Plane>(NativeCalls.godot_icall_4_561(MethodBind2, GodotObject.GetPtr(Singleton), radius, height, sides, (int)axis));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.BuildCapsulePlanes, 2113592876ul);
    ...
    /// </summary>
    public static Godot.Collections.Array<Plane> BuildCapsulePlanes(float radius, float height, int sides, int lats, Vector3.Axis axis = (Vector3.Axis)(2))
    {
        return new Godot.Collections.Array<Plane>(NativeCalls.godot_icall_5_562(MethodBind3, GodotObject.GetPtr(Singleton), radius, height, sides, lats, (int)axis));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind4 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetClosestPointsBetweenSegments, 1056373962ul);
    ...
    /// </summary>
    public static unsafe Vector3[] GetClosestPointsBetweenSegments(Vector3 p1, Vector3 p2, Vector3 q1, Vector3 q2)
    {
        return NativeCalls.godot_icall_4_563(MethodBind4, GodotObject.GetPtr(Singleton), &p1, &p2, &q1, &q2);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind5 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetClosestPointToSegment, 2168193209ul);
    ...
    /// </summary>
    public static unsafe Vector3 GetClosestPointToSegment(Vector3 point, Vector3 s1, Vector3 s2)
    {
        return NativeCalls.godot_icall_3_564(MethodBind5, GodotObject.GetPtr(Singleton), &point, &s1, &s2);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind6 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetClosestPointToSegmentUncapped, 2168193209ul);
    ...
    /// </summary>
    public static unsafe Vector3 GetClosestPointToSegmentUncapped(Vector3 point, Vector3 s1, Vector3 s2)
    {
        return NativeCalls.godot_icall_3_564(MethodBind6, GodotObject.GetPtr(Singleton), &point, &s1, &s2);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind7 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetTriangleBarycentricCoords, 1362048029ul);
    ...
    /// </summary>
    public static unsafe Vector3 GetTriangleBarycentricCoords(Vector3 point, Vector3 a, Vector3 b, Vector3 c)
    {
        return NativeCalls.godot_icall_4_565(MethodBind7, GodotObject.GetPtr(Singleton), &point, &a, &b, &c);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind8 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RayIntersectsTriangle, 1718655448ul);
    ...
    /// </summary>
    public static unsafe Variant RayIntersectsTriangle(Vector3 from, Vector3 dir, Vector3 a, Vector3 b, Vector3 c)
    {
        return NativeCalls.godot_icall_5_566(MethodBind8, GodotObject.GetPtr(Singleton), &from, &dir, &a, &b, &c);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind9 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SegmentIntersectsTriangle, 1718655448ul);
    ...
    /// </summary>
    public static unsafe Variant SegmentIntersectsTriangle(Vector3 from, Vector3 to, Vector3 a, Vector3 b, Vector3 c)
    {
        return NativeCalls.godot_icall_5_566(MethodBind9, GodotObject.GetPtr(Singleton), &from, &to, &a, &b, &c);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind10 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SegmentIntersectsSphere, 4080141172ul);
    ...
    /// </summary>
    public static unsafe Vector3[] SegmentIntersectsSphere(Vector3 from, Vector3 to, Vector3 spherePosition, float sphereRadius)
    {
        return NativeCalls.godot_icall_4_567(MethodBind10, GodotObject.GetPtr(Singleton), &from, &to, &spherePosition, sphereRadius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind11 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SegmentIntersectsCylinder, 2361316491ul);
    ...
    /// </summary>
    public static unsafe Vector3[] SegmentIntersectsCylinder(Vector3 from, Vector3 to, float height, float radius)
    {
        return NativeCalls.godot_icall_4_568(MethodBind11, GodotObject.GetPtr(Singleton), &from, &to, height, radius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SegmentIntersectsConvex, 537425332ul);
    ...
    /// </summary>
    public static unsafe Vector3[] SegmentIntersectsConvex(Vector3 from, Vector3 to, Godot.Collections.Array<Plane> planes)
    {
        return NativeCalls.godot_icall_3_569(MethodBind12, GodotObject.GetPtr(Singleton), &from, &to, (godot_array)(planes ?? new()).NativeValue);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClipPolygon, 2603188319ul);
    ...
    /// </summary>
    public static unsafe Vector3[] ClipPolygon(Vector3[] points, Plane plane)
    {
        return NativeCalls.godot_icall_2_570(MethodBind13, GodotObject.GetPtr(Singleton), points, &plane);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind14 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.TetrahedralizeDelaunay, 1230191221ul);
    ...
    {
        return NativeCalls.godot_icall_1_571(MethodBind14, GodotObject.GetPtr(Singleton), points);
    }
