...
#nullable disable
/// <summary>
/// <para>A container that keeps its child controls within the area of a <see cref="Godot.StyleBox"/>. Useful for giving controls an outline.</para>
/// </summary>
public partial class PanelContainer : Container
{
    private static readonly System.Type CachedType = typeof(PanelContainer);

    private static readonly StringName NativeName = "PanelContainer";
