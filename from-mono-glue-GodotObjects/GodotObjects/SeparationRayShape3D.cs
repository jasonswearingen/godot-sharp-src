...
#nullable disable
/// <summary>
/// <para>A 3D ray shape, intended for use in physics. Usually used to provide a shape for a <see cref="Godot.CollisionShape3D"/>. When a <see cref="Godot.SeparationRayShape3D"/> collides with an object, it tries to separate itself from it by moving its endpoint to the collision point. For example, a <see cref="Godot.SeparationRayShape3D"/> next to a character can allow it to instantly move up when touching stairs.</para>
/// </summary>
public partial class SeparationRayShape3D : Shape3D
{
    /// <summary>
    ...
    private static readonly System.Type CachedType = typeof(SeparationRayShape3D);

    private static readonly StringName NativeName = "SeparationRayShape3D";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public SeparationRayShape3D() : this(true)
    {
        unsafe
        {
    ...
    internal SeparationRayShape3D(bool memoryOwn) : base(memoryOwn) { }
