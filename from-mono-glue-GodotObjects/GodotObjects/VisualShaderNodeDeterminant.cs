...
{
    private static readonly System.Type CachedType = typeof(VisualShaderNodeDeterminant);

    private static readonly StringName NativeName = "VisualShaderNodeDeterminant";
