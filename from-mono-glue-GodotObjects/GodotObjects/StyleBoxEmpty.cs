...
#nullable disable
/// <summary>
/// <para>An empty <see cref="Godot.StyleBox"/> that can be used to display nothing instead of the default style (e.g. it can "disable" <c>focus</c> styles).</para>
/// </summary>
public partial class StyleBoxEmpty : StyleBox
{
    private static readonly System.Type CachedType = typeof(StyleBoxEmpty);

    private static readonly StringName NativeName = "StyleBoxEmpty";
