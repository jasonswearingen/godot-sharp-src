...
{
    private static readonly System.Type CachedType = typeof(VisualShaderNodeDotProduct);

    private static readonly StringName NativeName = "VisualShaderNodeDotProduct";
