...
#nullable disable
/// <summary>
/// <para>This class is used when loading a project that uses a <see cref="Godot.Material"/> subclass in 2 conditions:</para>
...
/// </summary>
public partial class PlaceholderMaterial : Material
{
    private static readonly System.Type CachedType = typeof(PlaceholderMaterial);

    private static readonly StringName NativeName = "PlaceholderMaterial";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public PlaceholderMaterial() : this(true)
    {
        unsafe
        {
    ...
    internal PlaceholderMaterial(bool memoryOwn) : base(memoryOwn) { }
