...
public static partial class ProjectSettings
{
    ...
    {
        return NativeCalls.godot_icall_1_124(MethodBind0, GodotObject.GetPtr(Singleton), name).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_446(MethodBind1, GodotObject.GetPtr(Singleton), name, value);
    }
    ...
    {
        return NativeCalls.godot_icall_2_883(MethodBind2, GodotObject.GetPtr(Singleton), name, defaultValue);
    }
    ...
    {
        return NativeCalls.godot_icall_1_135(MethodBind3, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default));
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind5 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetOrder, 2956805083ul);
    ...
    {
        NativeCalls.godot_icall_2_367(MethodBind5, GodotObject.GetPtr(Singleton), name, position);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind6 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetOrder, 1321353865ul);
    ...
    {
        return NativeCalls.godot_icall_1_127(MethodBind6, GodotObject.GetPtr(Singleton), name);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind7 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetInitialValue, 402577236ul);
    ...
    {
        NativeCalls.godot_icall_2_446(MethodBind7, GodotObject.GetPtr(Singleton), name, value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind8 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAsBasic, 2678287736ul);
    ...
    {
        NativeCalls.godot_icall_2_420(MethodBind8, GodotObject.GetPtr(Singleton), name, basic.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind9 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAsInternal, 2678287736ul);
    ...
    {
        NativeCalls.godot_icall_2_420(MethodBind9, GodotObject.GetPtr(Singleton), name, @internal.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind10 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AddPropertyInfo, 4155329257ul);
    ...
    {
        NativeCalls.godot_icall_1_113(MethodBind10, GodotObject.GetPtr(Singleton), (godot_dictionary)(hint ?? new()).NativeValue);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind11 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetRestartIfChanged, 2678287736ul);
    ...
    {
        NativeCalls.godot_icall_2_420(MethodBind11, GodotObject.GetPtr(Singleton), name, restart.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.Clear, 83702148ul);
    ...
    {
        NativeCalls.godot_icall_1_56(MethodBind12, GodotObject.GetPtr(Singleton), name);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LocalizePath, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_271(MethodBind13, GodotObject.GetPtr(Singleton), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind14 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GlobalizePath, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_271(MethodBind14, GodotObject.GetPtr(Singleton), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind15 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.Save, 166280745ul);
    ...
    {
        return (Error)NativeCalls.godot_icall_0_37(MethodBind15, GodotObject.GetPtr(Singleton));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind16 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LoadResourcePack, 708980503ul);
    ...
    {
        return NativeCalls.godot_icall_3_884(MethodBind16, GodotObject.GetPtr(Singleton), pack, replaceFiles.ToGodotBool(), offset).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind17 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SaveCustom, 166001499ul);
    ...
    {
        return (Error)NativeCalls.godot_icall_1_127(MethodBind17, GodotObject.GetPtr(Singleton), file);
    }
