...
/// </summary>
public partial class VisualShaderNodeBooleanParameter : VisualShaderNodeParameter
{
    /// <summary>
    /// <para>Enables usage of the <see cref="Godot.VisualShaderNodeBooleanParameter.DefaultValue"/>.</para>
    /// </summary>
    ...
    private static readonly System.Type CachedType = typeof(VisualShaderNodeBooleanParameter);

    private static readonly StringName NativeName = "VisualShaderNodeBooleanParameter";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public VisualShaderNodeBooleanParameter() : this(true)
    {
        unsafe
        {
    ...
    internal VisualShaderNodeBooleanParameter(bool memoryOwn) : base(memoryOwn) { }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDefaultValue, 2586408642ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetDefaultValue(bool value)
    {
        NativeCalls.godot_icall_1_41(MethodBind2, GodotObject.GetPtr(this), value.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDefaultValue, 36873697ul);
