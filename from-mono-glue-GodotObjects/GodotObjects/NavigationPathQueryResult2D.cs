...
#nullable disable
/// <summary>
/// <para>This class stores the result of a 2D navigation path query from the <see cref="Godot.NavigationServer2D"/>.</para>
/// </summary>
public partial class NavigationPathQueryResult2D : RefCounted
{
    ...
    /// <summary>
    /// <para>The resulting path array from the navigation query. All path array positions are in global coordinates. Without customized query parameters this is the same path as returned by <see cref="Godot.NavigationServer2D.MapGetPath(Rid, Vector2, Vector2, bool, uint)"/>.</para>
    /// </summary>
    public Vector2[] Path
    {
        get
    ...
    private static readonly System.Type CachedType = typeof(NavigationPathQueryResult2D);

    private static readonly StringName NativeName = "NavigationPathQueryResult2D";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public NavigationPathQueryResult2D() : this(true)
    {
        unsafe
        {
    ...
    internal NavigationPathQueryResult2D(bool memoryOwn) : base(memoryOwn) { }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind0 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetPath, 1509147220ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetPath(Vector2[] path)
    {
        NativeCalls.godot_icall_1_203(MethodBind0, GodotObject.GetPtr(this), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind1 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPath, 2961356807ul);
