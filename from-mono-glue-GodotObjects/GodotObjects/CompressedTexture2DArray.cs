...
#nullable disable
/// <summary>
/// <para>A texture array that is loaded from a <c>.ctexarray</c> file. This file format is internal to Godot; it is created by importing other image formats with the import system. <see cref="Godot.CompressedTexture2DArray"/> can use one of 4 compression methods:</para>
...
/// <para>See <see cref="Godot.Texture2DArray"/> for a general description of texture arrays.</para>
/// </summary>
public partial class CompressedTexture2DArray : CompressedTextureLayered
{
    private static readonly System.Type CachedType = typeof(CompressedTexture2DArray);

    private static readonly StringName NativeName = "CompressedTexture2DArray";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public CompressedTexture2DArray() : this(true)
    {
        unsafe
        {
    ...
    internal CompressedTexture2DArray(bool memoryOwn) : base(memoryOwn) { }
