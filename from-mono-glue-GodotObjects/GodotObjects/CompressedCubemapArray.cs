...
#nullable disable
/// <summary>
/// <para>A cubemap array that is loaded from a <c>.ccubearray</c> file. This file format is internal to Godot; it is created by importing other image formats with the import system. <see cref="Godot.CompressedCubemapArray"/> can use one of 4 compression methods:</para>
...
/// <para>See <see cref="Godot.CubemapArray"/> for a general description of cubemap arrays.</para>
/// </summary>
public partial class CompressedCubemapArray : CompressedTextureLayered
{
    private static readonly System.Type CachedType = typeof(CompressedCubemapArray);

    private static readonly StringName NativeName = "CompressedCubemapArray";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public CompressedCubemapArray() : this(true)
    {
        unsafe
        {
    ...
    internal CompressedCubemapArray(bool memoryOwn) : base(memoryOwn) { }
