...
#nullable disable
/// <summary>
/// <para>Resizable nodes have a handle that allows the user to adjust their size as needed.</para>
/// </summary>
public partial class VisualShaderNodeResizableBase : VisualShaderNode
{
    /// <summary>
    ...
    private static readonly System.Type CachedType = typeof(VisualShaderNodeResizableBase);

    private static readonly StringName NativeName = "VisualShaderNodeResizableBase";

    internal VisualShaderNodeResizableBase() : this(true)
    {
        unsafe
        {
    ...
    internal VisualShaderNodeResizableBase(bool memoryOwn) : base(memoryOwn) { }
