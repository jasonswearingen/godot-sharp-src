...
#nullable disable
/// <summary>
/// <para>Takes a 4×4 transform matrix and decomposes it into four <c>vec3</c> values, one from each row of the matrix.</para>
/// </summary>
public partial class VisualShaderNodeTransformDecompose : VisualShaderNode
{
    private static readonly System.Type CachedType = typeof(VisualShaderNodeTransformDecompose);

    private static readonly StringName NativeName = "VisualShaderNodeTransformDecompose";
