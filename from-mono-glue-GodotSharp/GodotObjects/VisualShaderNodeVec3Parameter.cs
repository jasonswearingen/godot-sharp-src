...
/// </summary>
public partial class VisualShaderNodeVec3Parameter : VisualShaderNodeParameter
{
    /// <summary>
    /// <para>Enables usage of the <see cref="Godot.VisualShaderNodeVec3Parameter.DefaultValue"/>.</para>
    /// </summary>
    ...
    private static readonly System.Type CachedType = typeof(VisualShaderNodeVec3Parameter);

    private static readonly StringName NativeName = "VisualShaderNodeVec3Parameter";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public VisualShaderNodeVec3Parameter() : this(true)
    {
        unsafe
        {
    ...
    internal VisualShaderNodeVec3Parameter(bool memoryOwn) : base(memoryOwn) { }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDefaultValue, 3460891852ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetDefaultValue(Vector3 value)
    {
        NativeCalls.godot_icall_1_163(MethodBind2, GodotObject.GetPtr(this), &value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDefaultValue, 3360562783ul);
