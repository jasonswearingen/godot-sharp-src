...
/// </summary>
public partial class VisualShaderNodeVec4Parameter : VisualShaderNodeParameter
{
    /// <summary>
    /// <para>Enables usage of the <see cref="Godot.VisualShaderNodeVec4Parameter.DefaultValue"/>.</para>
    /// </summary>
    ...
    private static readonly System.Type CachedType = typeof(VisualShaderNodeVec4Parameter);

    private static readonly StringName NativeName = "VisualShaderNodeVec4Parameter";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public VisualShaderNodeVec4Parameter() : this(true)
    {
        unsafe
        {
    ...
    internal VisualShaderNodeVec4Parameter(bool memoryOwn) : base(memoryOwn) { }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDefaultValue, 643568085ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetDefaultValue(Vector4 value)
    {
        NativeCalls.godot_icall_1_1314(MethodBind2, GodotObject.GetPtr(this), &value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDefaultValue, 2435802345ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Vector4 GetDefaultValue()
    {
        return NativeCalls.godot_icall_0_1315(MethodBind3, GodotObject.GetPtr(this));
    }
