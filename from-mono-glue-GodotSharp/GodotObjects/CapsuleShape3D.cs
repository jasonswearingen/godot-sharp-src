...
#nullable disable
/// <summary>
/// <para>A 3D capsule shape, intended for use in physics. Usually used to provide a shape for a <see cref="Godot.CollisionShape3D"/>.</para>
/// <para><b>Performance:</b> <see cref="Godot.CapsuleShape3D"/> is fast to check collisions against. It is faster than <see cref="Godot.CylinderShape3D"/>, but slower than <see cref="Godot.SphereShape3D"/> and <see cref="Godot.BoxShape3D"/>.</para>
/// </summary>
public partial class CapsuleShape3D : Shape3D
{
    /// <summary>
    ...
    private static readonly System.Type CachedType = typeof(CapsuleShape3D);

    private static readonly StringName NativeName = "CapsuleShape3D";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public CapsuleShape3D() : this(true)
    {
        unsafe
        {
    ...
    internal CapsuleShape3D(bool memoryOwn) : base(memoryOwn) { }
