...
/// <para>PointMeshes, must be used with a material that has a point size. Point size can be accessed in a shader with <c>POINT_SIZE</c>, or in a <see cref="Godot.BaseMaterial3D"/> by setting <see cref="Godot.BaseMaterial3D.UsePointSize"/> and the variable <see cref="Godot.BaseMaterial3D.PointSize"/>.</para>
...
{
    private static readonly System.Type CachedType = typeof(PointMesh);

    private static readonly StringName NativeName = "PointMesh";
