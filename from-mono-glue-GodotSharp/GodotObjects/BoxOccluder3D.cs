...
#nullable disable
/// <summary>
/// <para><see cref="Godot.BoxOccluder3D"/> stores a cuboid shape that can be used by the engine's occlusion culling system.</para>
/// <para>See <see cref="Godot.OccluderInstance3D"/>'s documentation for instructions on setting up occlusion culling.</para>
/// </summary>
public partial class BoxOccluder3D : Occluder3D
{
    /// <summary>
    /// <para>The box's size in 3D units.</para>
    /// </summary>
    public Vector3 Size
    {
        get
    ...
    private static readonly System.Type CachedType = typeof(BoxOccluder3D);

    private static readonly StringName NativeName = "BoxOccluder3D";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public BoxOccluder3D() : this(true)
    {
        unsafe
        {
    ...
    internal BoxOccluder3D(bool memoryOwn) : base(memoryOwn) { }
