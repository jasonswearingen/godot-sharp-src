...
#nullable disable
/// <summary>
/// <para><see cref="Godot.AnimatedSprite3D"/> is similar to the <see cref="Godot.Sprite3D"/> node, except it carries multiple textures as animation <see cref="Godot.AnimatedSprite3D.SpriteFrames"/>. Animations are created using a <see cref="Godot.SpriteFrames"/> resource, which allows you to import image files (or a folder containing said files) to provide the animation frames for the sprite. The <see cref="Godot.SpriteFrames"/> resource can be configured in the editor via the SpriteFrames bottom panel.</para>
/// </summary>
public partial class AnimatedSprite3D : SpriteBase3D
{
    ...
    /// <summary>
    /// <para>The current animation from the <see cref="Godot.AnimatedSprite3D.SpriteFrames"/> resource. If this value is changed, the <see cref="Godot.AnimatedSprite3D.Frame"/> counter and the <see cref="Godot.AnimatedSprite3D.FrameProgress"/> are reset.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>The displayed animation frame's index. Setting this property also resets <see cref="Godot.AnimatedSprite3D.FrameProgress"/>. If this is not desired, use <see cref="Godot.AnimatedSprite3D.SetFrameAndProgress(int, float)"/>.</para>
    /// </summary>
    public int Frame
    {
        get
    ...
    private static readonly System.Type CachedType = typeof(AnimatedSprite3D);

    private static readonly StringName NativeName = "AnimatedSprite3D";
    ...
    /// <summary>
    /// <para>Returns <see langword="true"/> if an animation is currently playing (even if <see cref="Godot.AnimatedSprite3D.SpeedScale"/> and/or <c>custom_speed</c> are <c>0</c>).</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Plays the animation with key <paramref name="name"/>. If <paramref name="customSpeed"/> is negative and <paramref name="fromEnd"/> is <see langword="true"/>, the animation will play backwards (which is equivalent to calling <see cref="Godot.AnimatedSprite3D.PlayBackwards(StringName)"/>).</para>
    ...
    /// <para>This method is a shorthand for <see cref="Godot.AnimatedSprite3D.Play(StringName, float, bool)"/> with <c>custom_speed = -1.0</c> and <c>from_end = true</c>, so see its description for more information.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Pauses the currently playing animation. The <see cref="Godot.AnimatedSprite3D.Frame"/> and <see cref="Godot.AnimatedSprite3D.FrameProgress"/> will be kept and calling <see cref="Godot.AnimatedSprite3D.Play(StringName, float, bool)"/> or <see cref="Godot.AnimatedSprite3D.PlayBackwards(StringName)"/> without arguments will resume the animation from the current playback position.</para>
    /// <para>See also <see cref="Godot.AnimatedSprite3D.Stop()"/>.</para>
    /// </summary>
    public void Pause()
    {
    ...
    /// <summary>
    /// <para>Stops the currently playing animation. The animation position is reset to <c>0</c> and the <c>custom_speed</c> is reset to <c>1.0</c>. See also <see cref="Godot.AnimatedSprite3D.Pause()"/>.</para>
    /// </summary>
    public void Stop()
    {
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetFrameProgress, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetFrameProgress(float progress)
    {
        NativeCalls.godot_icall_1_62(MethodBind13, GodotObject.GetPtr(this), progress);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind14 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetFrameProgress, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind15 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetFrameAndProgress, 1602489585ul);

    /// <summary>
    /// <para>The setter of <see cref="Godot.AnimatedSprite3D.Frame"/> resets the <see cref="Godot.AnimatedSprite3D.FrameProgress"/> to <c>0.0</c> implicitly, but this method avoids that.</para>
    /// <para>This is useful when you want to carry over the current <see cref="Godot.AnimatedSprite3D.FrameProgress"/> to another <see cref="Godot.AnimatedSprite3D.Frame"/>.</para>
    /// <para><b>Example:</b></para>
    /// <para></para>
    /// </summary>
    public void SetFrameAndProgress(int frame, float progress)
    {
        NativeCalls.godot_icall_2_64(MethodBind15, GodotObject.GetPtr(this), frame, progress);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind16 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetSpeedScale, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetSpeedScale(float speedScale)
    {
        NativeCalls.godot_icall_1_62(MethodBind16, GodotObject.GetPtr(this), speedScale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind17 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetSpeedScale, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind18 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPlayingSpeed, 1740695150ul);

    /// <summary>
    /// <para>Returns the actual playing speed of current animation or <c>0</c> if not playing. This speed is the <see cref="Godot.AnimatedSprite3D.SpeedScale"/> property multiplied by <c>custom_speed</c> argument specified when calling the <see cref="Godot.AnimatedSprite3D.Play(StringName, float, bool)"/> method.</para>
    ...
    /// <summary>
    /// <para>Emitted when <see cref="Godot.AnimatedSprite3D.SpriteFrames"/> changes.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Emitted when <see cref="Godot.AnimatedSprite3D.Animation"/> changes.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Emitted when <see cref="Godot.AnimatedSprite3D.Frame"/> changes.</para>
    /// </summary>
