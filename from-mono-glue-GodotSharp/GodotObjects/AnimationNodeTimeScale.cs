...
#nullable disable
/// <summary>
/// <para>Allows to scale the speed of the animation (or reverse it) in any child <see cref="Godot.AnimationNode"/>s. Setting it to <c>0.0</c> will pause the animation.</para>
/// </summary>
public partial class AnimationNodeTimeScale : AnimationNode
{
    private static readonly System.Type CachedType = typeof(AnimationNodeTimeScale);

    private static readonly StringName NativeName = "AnimationNodeTimeScale";
