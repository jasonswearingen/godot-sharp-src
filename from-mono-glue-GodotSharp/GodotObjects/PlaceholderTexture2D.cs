...
/// </summary>
public partial class PlaceholderTexture2D : Texture2D
{
    /// <summary>
    ...
    private static readonly System.Type CachedType = typeof(PlaceholderTexture2D);

    private static readonly StringName NativeName = "PlaceholderTexture2D";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public PlaceholderTexture2D() : this(true)
    {
        unsafe
        {
    ...
    internal PlaceholderTexture2D(bool memoryOwn) : base(memoryOwn) { }
