...
#nullable disable
/// <summary>
/// <para>Creates a 4×4 transform matrix using four vectors of type <c>vec3</c>. Each vector is one row in the matrix and the last column is a <c>vec4(0, 0, 0, 1)</c>.</para>
/// </summary>
public partial class VisualShaderNodeTransformCompose : VisualShaderNode
{
    private static readonly System.Type CachedType = typeof(VisualShaderNodeTransformCompose);

    private static readonly StringName NativeName = "VisualShaderNodeTransformCompose";
