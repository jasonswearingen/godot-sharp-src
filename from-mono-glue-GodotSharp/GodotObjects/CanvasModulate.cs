...
#nullable disable
/// <summary>
/// <para><see cref="Godot.CanvasModulate"/> applies a color tint to all nodes on a canvas. Only one can be used to tint a canvas, but <see cref="Godot.CanvasLayer"/>s can be used to render things independently.</para>
/// </summary>
public partial class CanvasModulate : Node2D
{
    ...
    private static readonly System.Type CachedType = typeof(CanvasModulate);

    private static readonly StringName NativeName = "CanvasModulate";
