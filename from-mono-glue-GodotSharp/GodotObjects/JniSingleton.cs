...
/// </summary>
[GodotClassName("JNISingleton")]
public partial class JniSingleton : GodotObject
{
    private static readonly System.Type CachedType = typeof(JniSingleton);

    private static readonly StringName NativeName = "JNISingleton";
