...
#nullable disable
/// <summary>
/// <para>A node created automatically in an <see cref="Godot.AnimationNodeBlendTree"/> that outputs the final animation.</para>
/// </summary>
public partial class AnimationNodeOutput : AnimationNode
{
    private static readonly System.Type CachedType = typeof(AnimationNodeOutput);

    private static readonly StringName NativeName = "AnimationNodeOutput";
