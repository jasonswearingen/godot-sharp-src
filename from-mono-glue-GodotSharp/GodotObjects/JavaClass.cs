...
#nullable disable
/// <summary>
/// <para>Represents an object from the Java Native Interface. It is returned from <see cref="Godot.JavaClassWrapper.Wrap(string)"/>.</para>
/// <para><b>Note:</b> This class only works on Android. For any other build, this class does nothing.</para>
