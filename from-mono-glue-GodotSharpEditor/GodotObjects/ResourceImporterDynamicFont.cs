...
/// <para>See also <see cref="Godot.ResourceImporterBMFont"/> and <see cref="Godot.ResourceImporterImageFont"/>.</para>
/// </summary>
public partial class ResourceImporterDynamicFont : ResourceImporter
{
    private static readonly System.Type CachedType = typeof(ResourceImporterDynamicFont);

    private static readonly StringName NativeName = "ResourceImporterDynamicFont";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public ResourceImporterDynamicFont() : this(true)
    {
        unsafe
        {
    ...
    internal ResourceImporterDynamicFont(bool memoryOwn) : base(memoryOwn) { }
