...
/// </summary>
public partial class EditorExportPlatformPC : EditorExportPlatform
{
    private static readonly System.Type CachedType = typeof(EditorExportPlatformPC);

    private static readonly StringName NativeName = "EditorExportPlatformPC";

    internal EditorExportPlatformPC() : this(true)
    {
        unsafe
        {
    ...
    internal EditorExportPlatformPC(bool memoryOwn) : base(memoryOwn) { }
