...
/// </summary>
[GodotClassName("EditorSceneFormatImporterUFBX")]
public partial class EditorSceneFormatImporterUfbx : EditorSceneFormatImporter
{
    private static readonly System.Type CachedType = typeof(EditorSceneFormatImporterUfbx);

    private static readonly StringName NativeName = "EditorSceneFormatImporterUFBX";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public EditorSceneFormatImporterUfbx() : this(true)
    {
        unsafe
        {
    ...
    internal EditorSceneFormatImporterUfbx(bool memoryOwn) : base(memoryOwn) { }
